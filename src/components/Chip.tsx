...
const ChipVariants = cva("font-medium", {
  variants: {
    variant: {
      ...
      option:
        "inline-flex items-center gap-[.8rem] pl-[1.2rem] pr-[.6rem] h-[2.8rem] rounded-md text-sm bg-gray-1 text-gray-9 data-[on=true]:bg-secondary-8 data-[on=true]:text-white",
      answer:
